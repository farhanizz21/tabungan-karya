...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="<?= base_url('karyaku/tambah'); ?>" class="btn btn-primary shadow-sm">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <a href="<?=base_url('karyaku/hapus/'.$row->uuid)?>" class="btn btn-sm btn-danger"
                                    data-toggle="tooltip" data-placement="top" title="Hapus Data">
                                    <i class="fas fa-trash"></i>
                                </a>
                                <a href="<?=base_url('karyaku/edit/'.$row->uuid)?>" class="btn btn-sm btn-warning"
